...
| `io` | Files, paths, streams, basic OS IO | Raw file read/write, File wrapper open/write/read/flush/seek/tell/close, failed-open/null guards, and portable path helpers are native-smoke gated; add directory listing and larger file/stream edge cases next. |
